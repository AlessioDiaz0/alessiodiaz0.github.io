...
const ApproachCard = ({
    ...
    return (
        <button
            type="button"
            className={[
                "group [perspective:1200px] w-full h-full cursor-pointer text-left",
        ...
        >
            ...
            >
                ...
                {/* Back */}
                <div className="absolute inset-0 h-full w-full [backface-visibility:hidden] [transform:rotateY(180deg)] flex flex-col items-center justify-center p-3 md:px-5 md:py-8 bg-[#130f2a] rounded-2xl border border-blue-500/40 shadow-2xl bg-gradient-to-br from-blue-900 to-purple-900">
                    <h2 className="text-blue-400 font-bold mb-2 md:mb-3 uppercase text-xs md:text-sm tracking-widest">
                        {name}
                    </h2>
                    <p className="text-gray-200 text-center text-xs sm:text-sm md:text-base leading-relaxed italic px-2">
                        "{description}"
                    </p>
                </div>
            </motion.div>
